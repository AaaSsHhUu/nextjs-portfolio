...
const AceternityIcon = ({order} : {order : string}) => {
    return (
        <div>
            <button className="absolute top-[50%] left[50%] translate-x-[-50%] translate-y-[-50%] inline-flex h-12 animate-shimmer items-center justify-center rounded-lg border border-slate-800 bg-[linear-gradient(110deg,#000319,45%,#8a27da,55%,#000319)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                {order}
            </button>
        </div>
    );
