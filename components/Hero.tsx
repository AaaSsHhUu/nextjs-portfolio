...
const Hero = () => {
    return (
        <div className='pb-20 pt-15'>
            ...
            <div className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.1] bg-grid-black/[0.2] flex items-center justify-center relative">
                ...
                <div className='flex justify-center relative my-20 z-10 '>
                    <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                        ...
                        <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-xl'>Hi, I'm Ashu, a Next.js Developer based in India.</p>
